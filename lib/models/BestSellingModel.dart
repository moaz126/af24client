...
// import 'dart:convert';
//
// List<BestSellingModel> bestSellingModelFromJson(String str) => List<BestSellingModel>.from(json.decode(str).map((x) => BestSellingModel.fromJson(x)));
//
// String bestSellingModelToJson(List<BestSellingModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
//
