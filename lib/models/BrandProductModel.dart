...
// //
// //     final brandProductModel = brandProductModelFromJson(jsonString);
//
// import 'dart:convert';
// import 'dart:ffi';
//
// List<BrandProductModel> brandProductModelFromJson(String str) => List<BrandProductModel>.from(json.decode(str).map((x) => BrandProductModel.fromJson(x)));
//
// String brandProductModelToJson(List<BrandProductModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
//
...
//
//   factory BrandProductModel.fromJson(Map<String, dynamic> json) => BrandProductModel(
//     id: json["id"],
