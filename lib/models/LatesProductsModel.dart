...
// //
// //     final latestProductsModel = latestProductsModelFromJson(jsonString);
//
// import 'dart:convert';
//
// List<LatestProductsModel> latestProductsModelFromJson(String str) => List<LatestProductsModel>.from(json.decode(str).map((x) => LatestProductsModel.fromJson(x)));
//
// String latestProductsModelToJson(List<LatestProductsModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
//
...
//     size: json["size"],
//     secret_comment: json["secret_comment"],
...
List<LatestProductsModel> latestProductsModelFromJson(String str) =>
    List<LatestProductsModel>.from(
        json.decode(str).map((x) => LatestProductsModel.fromJson(x)));

String latestProductsModelToJson(List<LatestProductsModel> data) =>
...
class LatestProductsModel {
  LatestProductsModel({
    ...
    required this.color,
    required this.secretComment,
    required this.secretComments,
    required this.rating,
    required this.brand,
    required this.translations,
    required this.reviews,
    required this.first_price_down,
  });
  ...
  factory LatestProductsModel.fromJson(Map<String, dynamic> json) =>
      LatestProductsModel(
        ...
        images: List<String>.from(json["images"].map((x) => x)),
        thumbnail: json["thumbnail"],
        first_price_down: json['first_price_down'],
        ...
        deliveryReturns:
            json["delivery_returns"] == null ? null : json["delivery_returns"],
        reviewsCount: json["reviews_count"],
        sellerName: json["seller_name"],
        color: json["color"],
        secretComment: json["secret_comment"],
