...
import 'FavouritesListScreen.dart';


class AddToFavouritesScreen extends StatefulWidget {
  const AddToFavouritesScreen({Key? key}) : super(key: key);
      ...
      Scaffold(
        appBar: AppBar(
          ...
          title: Padding(
            ...
            child: Text(Languages.of(context)!.ADD_FAVOURITE,
                style:
          ...
          actions: [
            ...
            InkWell(
              ...
              //   ),
              // ),
              child: Center(child: Text(Languages.of(context)!.VIEW_FAVOURITES,style: TextStyle(color: Colors.black,fontSize: 7.sp),)),
            ),
            SizedBox(
              width: 10,
            ),
                                    ...
                                    child: ElevatedButton(
                                      onPressed: () async {
                                        ...
                                        else
                                        {
                                          ...
                                          await DataApiService.instance.addToFavourites(allSellers[index].sellerId.toString());
                                          await DataApiService.instance.getFavouritesSellersList();
                                          setState(() {
                                      ...
                                      Guest == 1 ? Text(Languages.of(context)!.ADD_FAVOURITE) :
                                      ...
                                      Text(Languages.of(context)!.REMOVE_FAVOURITES,maxLines: 1,overflow: TextOverflow.ellipsis,style: TextStyle(fontSize: 10.sp),)
                                              :
                                      Text(Languages.of(context)!.ADD_FAVOURITE,style: TextStyle(fontSize: 10.sp)),
                                      style: ButtonStyle(
                                          backgroundColor:
