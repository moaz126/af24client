...
class BrandProductDetails extends StatefulWidget {
  final int index;
  BrandProductDetails(this.index);

  @override
  State<BrandProductDetails> createState() => _BrandProductDetailsState();
}

class _BrandProductDetailsState extends State<BrandProductDetails> {
  bool CheckFollow()
  {
    for(int i=0; i<FollowBrands.length;i++)
    {
      if(FollowBrands[i]==brandList[widget.index].id.toString())
        {
          return true;
        }
    }
  ...
  async {
    ...
    await DataApiService.instance.getBrandProduct(brandList[widget.index].id);
    setState(() {
      Productloader = false;
    });
    if(Guest == 1)
    ...
    else
    {
      await DataApiService.instance
          .getBrandFollowList(sellerinfo!.id.toString());
      setState(() {
        Followloader = false;
      });
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Text(brandList[widget.index].name,
              style:
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
                      ...
                      children: [
                        ...
                        ClipOval(
                          ...
                          CachedNetworkImage(
                            ...
                            width: 9.h,
                            imageUrl:
                            'https://becknowledge.com/af24/public/storage/brand/'+brandList[widget.index].image,
                            fit: BoxFit.contain,
                          ...
                          //Image.network(height: 9.h,width: 9.h,fit: BoxFit.cover,'https://becknowledge.com/af24/public/storage/brand/'+brandList[widget.index].image),
                        ),
                        Padding(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        else
                        {
                                ...
                                await DataApiService.instance.requestFollow(
                                    brandList[widget.index].id.toString(),
              ...
              Row(
                children: [
                  Text(Languages.of(context)!.PRODUCT + ' ('+'${brandProduct.length}'+')',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14.sp),),
                ],
              ),
              // GridView(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          InkWell(
                            onTap: () async {
                              // await DataApiService.instance.getProductDetails(brandProduct[index].slug);
                              Get.to(ProductDetailsScreen(brandProduct[index].slug.toString()));
                            },
                            child: Column(
                                ...
                                Row(
                                  children: [
                                    CachedNetworkImage(
                                      ...
                                      width: 40.w,
                                      imageUrl:
                                      'https://becknowledge.com/af24/public/storage/product/'+brandProduct[index].images[0].toString(),
                                      fit: BoxFit.fitWidth,
                                      placeholder: (context, url) =>
                                          shimmerCategoryLoader(),
                                      errorWidget:
                                    ...
                                    //Image.network('https://becknowledge.com/af24/public/storage/product/'+brandProduct[index].images[0].toString(), height:15.h,width: 40.w,fit: BoxFit.fitWidth,),
                                  ],
                                ),
                                Row(
                                  children: [
                                    Container(width: 40.w, child: Text('${brandProduct[index].brand.name}',style: TextStyle(fontWeight: FontWeight.bold),maxLines: 1,overflow: TextOverflow.ellipsis,)),
                                  ],
                                ),
                                Row(
                                  children: [
                                    Container(width: 40.w, child: Text('${brandProduct[index].name}',style: TextStyle(fontWeight: FontWeight.bold),maxLines: 1,overflow: TextOverflow.ellipsis,)),
                                  ],
                                ),
                          ...
                          Container(
                            child: Row(
                              children: [
                                Text('${brandProduct[index].unitPrice}',style: TextStyle(height: 0.2.h,fontWeight: FontWeight.bold,color: Colors.red),maxLines: 2,overflow: TextOverflow.ellipsis,),
                                Text(
                                  "€",
                                  style: TextStyle(
                                      fontSize: 13.sp,
