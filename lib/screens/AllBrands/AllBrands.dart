    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Text(Languages.of(context)!.ALL_BRANDS,
              style:
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text(Languages.of(context)!.ALL_BRANDS + ' ('+'${brandList.length}'+')',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14.sp),),
                  ),
                ],
              ),
              // GridView(
                              ...
                              InkWell(
                                ...
                                child: ClipOval(
                                  ...
                                  CachedNetworkImage(
                                    ...
                                    width: 9.h,
                                    imageUrl:
                                    'https://becknowledge.com/af24/public/storage/brand/' + brandList[index].image,
                                    fit: BoxFit.contain,
