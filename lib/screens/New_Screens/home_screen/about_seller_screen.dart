...
class ABoutSellerScreen extends StatefulWidget {
  const ABoutSellerScreen({Key? key}) : super(key: key);

  @override
  State<ABoutSellerScreen> createState() => _ABoutSellerScreenState();
}

class _ABoutSellerScreenState extends State<ABoutSellerScreen> {
  bool gridview =true;
  bool listview =false;
  bool active =true;
  bool sold =false;
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              CommonAppBarContainer(title: 'About Seller', onClicked: (){
                Get.back();
              }),
                                  ...
                                  Row(
                                    children: [
                                      Container(
                                        ...
                                        child: Center(child: Text('YK',style: TextStyles.TitleTexStyle11(),)),
                                      ),
                                      SizedBox(
                                        width: 3,
                                      ),
                                      Text('Youngmin Kim',style: TextStyles.TitleTexStyle11(),)
                                    ],
                                  ),
                                  // Padding(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                       ...
                       Text('137 followers',style: TextStyles.TitleTexStyle11(),)
                      ],
                    ),
                    SizedBox(
                      width: 32,
                    ...
                    Row(
                      children: [
                        ...
                        Text('Follow this seller',style: TextStyles.TitleTexStyle11().copyWith(
                          fontWeight: FontWeight.normal
                        ),)
                      ],
                    )
